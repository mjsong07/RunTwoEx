...
{  
	...
	[currentComposeViewController addURL:[NSURL URLWithString:G_KEY_SOX_RUNTWO_URL]];
	currentComposeViewController.completionHandler = ^(SLComposeViewControllerResult result){
		switch (result)
		{
			case SLComposeViewControllerResultDone:
//                [SOXUtil showAlert:@"Info!" :@"Share success!"];
				break;
   ...
   // if([baseRootView parentViewController] !=nil){
